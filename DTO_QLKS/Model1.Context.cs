...
namespace DTO_QLKS
{
    ...
    public partial class QL_KhachSanEntities : DbContext
    {
        ...
        public DbSet<DanhSachNhanVien> DanhSachNhanViens { get; set; }
        ...
        public virtual int InsertChiTietPhieuDatPhong(string maPDP, string maPhong, Nullable<System.DateTime> ngayDat, Nullable<System.DateTime> ngayKetThuc, Nullable<System.TimeSpan> gioDat, Nullable<System.TimeSpan> gioKetThuc, Nullable<int> soNguoi)
        {
            var maPDPParameter = maPDP != null ?
                new ObjectParameter("MaPDP", maPDP) :
                new ObjectParameter("MaPDP", typeof(string));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("InsertChiTietPhieuDatPhong", maPDPParameter, maPhongParameter, ngayDatParameter, ngayKetThucParameter, gioDatParameter, gioKetThucParameter, soNguoiParameter);
        }
        ...
        public virtual int InsertHoaDon(string maPDP, string maPhong, Nullable<double> tongGiaTri)
        {
            var maPDPParameter = maPDP != null ?
                new ObjectParameter("MaPDP", maPDP) :
                new ObjectParameter("MaPDP", typeof(string));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("InsertHoaDon", maPDPParameter, maPhongParameter, tongGiaTriParameter);
        }
        ...
        public virtual int InsertPhieuDatPhong(string maKH, string maNV)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("InsertPhieuDatPhong", maKHParameter, maNVParameter);
        }
